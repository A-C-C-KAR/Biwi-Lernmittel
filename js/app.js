                        ...
                        <div class="divide-y divide-stone-100">
                            ${cat.questions.map(q => `
                                <div class="p-6 hover:bg-stone-50/50 transition-colors group">
                                    <button id="btn-question-${q.id}" aria-expanded="false" aria-controls="answer-${q.id}" class="w-full text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded flex items-start justify-between cursor-pointer" onclick="app.toggleQuestion(${q.id})">
