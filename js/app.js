        const app = {
            ...
            toggleQuestion(id) {
                ...
                if (toggleBtn) toggleBtn.setAttribute('aria-expanded', !isHidden);
            },
            ...
            expandAll() {
                ...
                document.querySelectorAll('[id^="btn-toggle-"]').forEach(el => el.setAttribute('aria-expanded', 'true'));
            },
            ...
            collapseAll() {
                ...
                document.querySelectorAll('[id^="btn-toggle-"]').forEach(el => el.setAttribute('aria-expanded', 'false'));
            },
                        ...
                        <div class="divide-y divide-stone-100">
                            ${cat.questions.map(q => `
                                <div class="p-6 hover:bg-stone-50/50 transition-colors group">
                                    <button type="button" id="btn-toggle-${q.id}" class="flex items-start justify-between cursor-pointer text-left w-full focus-visible:ring-2 focus-visible:ring-emerald-500 focus:outline-none rounded-md" onclick="app.toggleQuestion(${q.id})" aria-expanded="false" aria-controls="answer-${q.id}">
