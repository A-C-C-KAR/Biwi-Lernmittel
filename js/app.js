        const app = {
            ...
            toggleQuestion(id) {
                ...
                const btn = document.getElementById(`question-btn-${id}`);
                if (btn) btn.setAttribute('aria-expanded', !answerEl.classList.contains('hidden'));
            },
            ...
            expandAll() {
                ...
                document.querySelectorAll('[id^="question-btn-"]').forEach(el => el.setAttribute('aria-expanded', 'true'));
            },
            ...
            collapseAll() {
                ...
                document.querySelectorAll('[id^="question-btn-"]').forEach(el => el.setAttribute('aria-expanded', 'false'));
            },
                        ...
                        <div class="divide-y divide-stone-100">
                            ${cat.questions.map(q => `
                                <div class="p-6 hover:bg-stone-50/50 transition-colors group">
                                    <button class="w-full text-left flex items-start justify-between cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded" onclick="app.toggleQuestion(${q.id})" aria-expanded="false" aria-controls="answer-${q.id}" id="question-btn-${q.id}">
