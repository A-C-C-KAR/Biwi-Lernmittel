                        ...
                        <div class="divide-y divide-stone-100">
                            ${cat.questions.map(q => `
                                <div class="p-6 hover:bg-stone-50/50 transition-colors group">
                                    <button type="button" aria-expanded="false" aria-controls="answer-${q.id}" id="btn-question-${q.id}" class="w-full flex items-start justify-between cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded" onclick="app.toggleQuestion(${q.id})">
