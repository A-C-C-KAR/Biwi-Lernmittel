        const app = {
            ...
            toggleQuestion(id) {
                ...
                const btnEl = document.getElementById(`q-btn-${id}`);
                if(btnEl) btnEl.setAttribute('aria-expanded', !answerEl.classList.contains('hidden'));
            },
            ...
            expandAll() {
                ...
                document.querySelectorAll('[id^="q-btn-"]').forEach(el => el.setAttribute('aria-expanded', 'true'));
            },
            ...
            collapseAll() {
                ...
                document.querySelectorAll('[id^="q-btn-"]').forEach(el => el.setAttribute('aria-expanded', 'false'));
            },
                        ...
                        <div class="divide-y divide-stone-100">
                            ${cat.questions.map(q => `
                                <div class="p-6 hover:bg-stone-50/50 transition-colors group">
                                    <button type="button" id="q-btn-${q.id}" class="w-full flex items-start justify-between cursor-pointer text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-lg p-1 -m-1" onclick="app.toggleQuestion(${q.id})" aria-expanded="false" aria-controls="answer-${q.id}">
