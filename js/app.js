        const app = {
            ...
            toggleQuestion(id) {
                ...
                if (triggerEl) {
                    triggerEl.setAttribute('aria-expanded', !isHidden);
                }
            },
            ...
            expandAll() {
                ...
                document.querySelectorAll('[id^="trigger-"]').forEach(el => el.setAttribute('aria-expanded', 'true'));
            },
            ...
            collapseAll() {
                ...
                document.querySelectorAll('[id^="trigger-"]').forEach(el => el.setAttribute('aria-expanded', 'false'));
            },
                        ...
                        <div class="divide-y divide-stone-100">
                            ${cat.questions.map(q => `
                                <div class="p-6 hover:bg-stone-50/50 transition-colors group">
                                    <button id="trigger-${q.id}" class="w-full text-left flex items-start justify-between cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-md" aria-expanded="false" aria-controls="answer-${q.id}" onclick="app.toggleQuestion(${q.id})">
                                        ...
                                        <svg id="chevron-${q.id}" class="w-5 h-5 text-stone-400 transform transition-transform duration-200 mt-1 flex-shrink-0 group-hover:text-emerald-600 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                                    </button>
