        const app = {
            ...
            expandAll() {
                ...
                document.querySelectorAll('[id^="btn-q-"]').forEach(el => el.setAttribute('aria-expanded', 'true'));
            },
            ...
            collapseAll() {
                ...
                document.querySelectorAll('[id^="btn-q-"]').forEach(el => el.setAttribute('aria-expanded', 'false'));
            },
                        ...
                        <div class="divide-y divide-stone-100">
                            ${cat.questions.map(q => `
                                <div class="p-6 hover:bg-stone-50/50 transition-colors group">
                                    <button id="btn-q-${q.id}" class="flex items-start justify-between cursor-pointer w-full text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-lg" aria-expanded="false" aria-controls="answer-${q.id}" onclick="app.toggleQuestion(${q.id})">
