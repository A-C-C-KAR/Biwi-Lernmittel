        const app = {
            ...
            toggleQuestion(id) {
                ...
                const btnEl = document.querySelector(`button[aria-controls="answer-${id}"]`);
                if (btnEl) {
                    btnEl.setAttribute('aria-expanded', !isHidden);
                }
            },
            ...
            expandAll() {
                ...
                document.querySelectorAll('button[aria-controls^="answer-"]').forEach(el => el.setAttribute('aria-expanded', 'true'));
            },
            ...
            collapseAll() {
                ...
                document.querySelectorAll('button[aria-controls^="answer-"]').forEach(el => el.setAttribute('aria-expanded', 'false'));
            },
                        ...
                        <div class="divide-y divide-stone-100">
                            ${cat.questions.map(q => `
                                <div class="p-6 hover:bg-stone-50/50 transition-colors group">
                                    <button type="button" class="flex items-start justify-between cursor-pointer w-full text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-md p-1 -m-1" onclick="app.toggleQuestion(${q.id})" aria-expanded="false" aria-controls="answer-${q.id}">
